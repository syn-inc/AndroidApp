...
public class Humidity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView1 = findViewById(R.id.current_value);
    ...
    class getTemp extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            respones.ResponesHistory("2019-02-14", "2019-03-15", 2, 1);
        }
    ...
    public void getArrayListMinMax(ArrayList<Float> a) {
        ...
        minGraphValue = minValue - 10;
        maxGraphValue = maxValue + 10;
    }
    ...
    public void updateHumGraph() {
        ...
        LineDataSet dataSet = new LineDataSet(entries, "Humidity for the last day");
